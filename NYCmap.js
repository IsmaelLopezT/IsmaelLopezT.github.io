...
function minMax(toGet, d) {
    ...
    return [d3.min(data, function(i) {
        return i.properties[toGet];
...
function bDistrict(d) {
    var ManString = ["Manhattan", 100],
        BronxString = ["Bronx", 200],
        BrookString = ["Brooklyn", 300],
        qString = ["Queens", 400],
        StateString = ["Staten Island", 500];
